...
export const translations = {
    ...
    tpi: {
        ...
        Community: 'Komuniti',
        House: 'Haus',
        Path: 'Rot blo walkabout',
        Factory: 'Factori',
        Road: 'Rot blo kar',
        Construction: 'Hap blo wok',
        'Oil and gas extraction': 'Oil and gas ples',
        Energy: 'Pawa',
        ...
        Mangrove: 'Mangro',
        'Beautiful scenery': 'Gupla ples',
        People: 'Pasin',
        'Fishing site': 'Hap blo painim pis',
        'Hunting site': 'Hap blo kilim abus',
        'Gathering site': 'Ples blo bung',
        Farmland: 'Ples garden',
        Aquaculture: 'Pasin blo lukautim pis',
        Medicine: 'Marasin',
        'Sacred site': 'Peles tambu',
        History: 'Histori',
        Employment: 'Wok',
        Tourism: 'Luk luk raun',
        'Artisanal Mining': 'Alluvial minin',
        'Commercial Mining': 'Minin ples',
        Poaching: 'Stiealim ol animal blo blush',
        Deforestation: 'Bagarapim bush',
        Conflict: 'Heavi',
        Hazard: 'Toksave lo samting nogut',
        Threat: 'Birua',
        Fire: 'Paia',
        Pollution: 'Pollusen',
        Volcano: 'Mountain paia',
        Earthquake: 'Graun guria',
        Tsunami: 'Bigpla solwara kirap',
        Landslide: 'Graun i kapsait',
        Erosion: 'Graun bagarup',
        Drought: 'Graun i dri',
        Flooding: 'Wara karapim ples',
        Vandalism: 'Bagarapim ol samtinlo komuniti',
    },
};
